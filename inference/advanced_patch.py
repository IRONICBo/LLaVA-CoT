...
class TransformersRuntimePatcher:
    ...
    def patch_module_from_file(self,
        ...
        Args:
            module_path: 要替换的模块路径，如 'transformers.models.mllama.processing_mllama'
            custom_file_path: 自定义模块文件路径
            backup: 是否备份原始模块
    ...
    def patch_mllama_processor(self, custom_file_path: Optional[str] = None) -> bool:
        ...
        Args:
            custom_file_path: 自定义处理器文件路径，默认为当前目录下的 processing_mllama.py
